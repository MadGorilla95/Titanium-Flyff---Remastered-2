...
void CModelViewer::SetReferenceModelID(int id)
{
	...
	ModelMng->SetModelPath("Data/Model/");
	TextureMng->SetModelTexturePath("Data/Model/");
	...
	//Model Preview - Kiyo
	else if (id == SEX_MONSTER)
	{
		m_referenceMesh->Load("mvr_AiBatt.o3d");
		m_referenceMesh->SetMotion("mvr_AiBatt_stand.ani");
	}
	else if (id == SEX_CLOAK)
	{
		m_referenceMesh->Load("Part_maleCloakLeo.o3d");
		m_referenceMesh->SetMotion("mvr_male_GenStand.ani");
	}
	else if (id == SEX_WINGS)
	{
		m_referenceMesh->Load("Template_Wings.o3d");
	}
	else if (id == SEX_MASKM)
	{
		m_referenceMesh->Load("Part_mMasksoul01.o3d");
		m_referenceMesh->SetMotion("mvr_male_GenStand.ani");
	}
	else if (id == SEX_MASKF)
	{
		m_referenceMesh->Load("Part_fMasksoul01.o3d");
		m_referenceMesh->SetMotion("mvr_female_GenStand.ani");
	}
	else if (id == SEX_2HSWORD)
	{
		m_referenceMesh->Load("Item_WeaSwtBehemoth.o3d");
	}
	else if (id == SEX_1HSWORD)
	{
		m_referenceMesh->Load("Item_WeaSwoBehemoth.o3d");
	}
	else if (id == SEX_2AXT)
	{
		m_referenceMesh->Load("Item_WeaAxtBehemoth.o3d");
	}
	else if (id == SEX_1AXE)
	{
		m_referenceMesh->Load("Item_WeaAxeBehemoth.o3d");
	}
	else if (id == SEX_KNUCKLE)
	{
		m_referenceMesh->Load("Item_WeaKnuBehemoth.o3d");
	}
	else if (id == SEX_STICK)
	{
		m_referenceMesh->Load("Item_WeaCheBehemoth.o3d");
	}
	else if (id == SEX_WAND)
	{
		m_referenceMesh->Load("Item_WeaWanBehemoth.o3d");
	}
	else if (id == SEX_STAFF)
	{
		m_referenceMesh->Load("Item_WeaStaBehemoth.o3d");
	}
	else if (id == SEX_BOW)
	{
		m_referenceMesh->Load("Item_WeaBeheBow.o3d");
	}
	else if (id == SEX_YOYO)
	{
		m_referenceMesh->Load("Item_WeaYoyBehemoth.o3d");
	}
	else if (id == SEX_SHIELD)
	{
		m_referenceMesh->Load("Item_WeaShiBehemoth.o3d");
	}
	else if (id == SEX_ZEM)
	{
		m_referenceMesh->Load("Item_WeaZemBehemoth.o3d");
	}
	else if (id == SEX_BOK)
	{
		m_referenceMesh->Load("Item_WeaBokBehemoth.o3d");
	}
}
