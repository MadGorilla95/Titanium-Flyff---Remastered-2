...
bool CMainFrame::Initialize()
{
	...
	OpenFile("Data/Model/Part_femaleHair06.o3d");
	OpenFile("Data/Model/Part_femaleHead01.o3d");
	OpenFile("Data/Model/Part_femaleHand.o3d");
	OpenFile("Data/Model/Part_femaleLower.o3d");
	OpenFile("Data/Model/Part_femaleUpper.o3d");
	OpenFile("Data/Model/Part_femaleFoot.o3d");
	OpenFile("Data/Model/mvr_female_GenStand.ani");
...
{
	const string filename = QFileDialog::getOpenFileName(this, tr("Charger un sfx"), m_filename.isEmpty() ? "Data/SFX/" : m_filename, tr("Fichier SFX") % " (*.sfx);; " % tr("Fichier 3D") % " (*.o3d);; " % tr("Fichier d'animation") % " (*.ani)");
...
void CMainFrame::SaveFile()
{
	if (m_filename.isEmpty())
	{
		m_filename = QFileDialog::getSaveFileName(this, tr("Enregistrer le SFX"), "Data/SFX/", tr("Fichier SFX") % " (*.sfx)");
...
{
	const string filename = QFileDialog::getSaveFileName(this, tr("Enregistrer le SFX"), "Data/SFX/", tr("Fichier SFX") % " (*.sfx)");
