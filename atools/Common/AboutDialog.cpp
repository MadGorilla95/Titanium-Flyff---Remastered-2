	...
	: QDialog(mainWindow)
{
	...
	label->setText("ATools v" % string::number(VERSION) % '.' % string::number(SUB_VERSION) % " - " % tr("Par") % " Aishiro, Zetsumi, Kiyo"
		% "<br/>Made for Titanium MMO"
		% "<br/>" % tr("Splashscreen and logo by") % " Kiyo"
		% "<br/>" % tr("Icônes de") % " <a href=\"http://icons8.com/\">Icons8 & Kiyo</a>");
