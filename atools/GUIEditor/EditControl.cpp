...
void CMainFrame::SetControlTexture()
{
	...
	const string texture = QFileDialog::getOpenFileName(this, tr("Charger une texture"), "/Data/Theme/" % CWndControl::s_selection[0]->GetTextureName(), tr("Fichier texture") % " (*.bmp *.tga)");
	if (!texture.isEmpty())
	{
