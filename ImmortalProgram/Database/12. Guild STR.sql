...
GO
/****** Object:  StoredProcedure [dbo].[GUILD_STR]    Script Date: 17/11/2020 23:13:10 ******/
SET ANSI_NULLS ON
GO
...
IF @iGu = 'S1'
	BEGIN
		SELECT  m_idGuild,serverindex,Lv_1,Lv_2,Lv_3,Lv_4,Pay_0,Pay_1,Pay_2,Pay_3,Pay_4,m_szGuild,m_nLevel,
						...
						m_dwLogo,m_szNotice, m_dwGuildColor_1, m_dwGuildColor_2, m_dwGuildColor_3
		   FROM GUILD_TBL 
					...
					BEGIN
						INSERT  GUILD_TBL
							(
								...
								m_szNotice,isuse,CreateTime,m_dwGuildColor_1,m_dwGuildColor_2,m_dwGuildColor_3
							)
						VALUES
							(
								@im_idGuild,@iserverindex,@iLv_1,@iLv_2,@iLv_3,@iLv_4,0,0,0,0,0,
							 	@im_szGuild,1,0,0,
								0,0,0,0,@im_dwLogo,
								@im_szNotice,'T',GETDATE(),255,255,255
							)
