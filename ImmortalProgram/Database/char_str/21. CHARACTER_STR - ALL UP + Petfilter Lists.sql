...
, @im_nCollectingTime bigint = 0	/*Achievement Collecting*/
, @im_nLastOnline bigint = 0		/*last online*/
, @im_nOnlineTime bigint = 0		/*online time*/
, @im_nCraftingExp int = 0			/*crafting exp*/
, @im_nDeleted int = 0			/*deleted char check*/
, @im_nAutoStat int = 0			/*auto stats*/
, @im_nRebirthLevel int = 0			/*Rebirth*/
, @im_nSelectedBag int = 0			/*Bag Loot*/
, @im_dwPetfilter bigint = 0			/*Petfilter DB*/
, @im_szPetfilterLists varchar(4096) = '$'	/*Petfilter Lists*/
/*******************************************************
	Gu Â¡Â¾Â¢Â¬Â¨Â¬Â¨Â¢
    S : SELECT
    I  : INSERT
	...
	BEGIN
				...
				SELECT	m_chLoginAuthority = @om_chLoginAuthority,
							...
							------------------- Version9 Pet
								...
								, A.m_nCollectingTime /*Achievement Collecting*/
								, A.m_nLastOnline		/*last online*/
								, A.m_nOnlineTime		/*online time*/
								, A.m_nCraftingExp		/*crafting exp*/
								, A.m_nDeleted			/*deleted char check*/
								, A.m_nAutoStat			/*auto stats*/
								, A.m_nRebirthLevel		/*Rebirth*/
								, A.m_nSelectedBag		/*Bag Loot*/
								, A.m_dwPetfilter		/*Petfilter DB*/
								, A.m_szPetfilterLists	/*Petfilter Lists*/
		...
		UPDATE CHARACTER_TBL
		      SET	dwWorldID 				= @idwWorldID,
					...
					--------------------- Version9 Pet
						...
						, m_nCollectingTime = @im_nCollectingTime	/*Achievement Collecting*/
						, m_nLastOnline = @im_nLastOnline	/*last online*/
						, m_nOnlineTime = @im_nOnlineTime	/*online time*/
						, m_nCraftingExp = @im_nCraftingExp		/*crafting exp*/
						, m_nDeleted = @im_nDeleted			/*deleted char check*/
						, m_nAutoStat = @im_nAutoStat		/*auto stats*/
						, m_nRebirthLevel = @im_nRebirthLevel 	/*Rebirth*/
						, m_nSelectedBag = @im_nSelectedBag		/*Bag Loot*/
						, m_dwPetfilter	= @im_dwPetfilter		/*Petfilter DB*/
						, m_szPetfilterLists = @im_szPetfilterLists	/*Petfilter Lists*/
				WHERE   m_idPlayer                              = @im_idPlayer  
				AND 	serverindex 				= @iserverindex
    ...
    ELSE  
		BEGIN
			DECLARE
								...
								, @om_ncR int				/*Name Color Change*/
								, @om_ncG int				/*Name Color Change*/
								, @om_ncB int				/*Name Color Change*/
								, @om_nCollectingTime bigint /*Achievement Collecting*/
								, @om_nLastOnline bigint	/*last online*/
								, @om_nOnlineTime bigint	/*online time*/
								, @om_nCraftingExp int		/*crafting exp*/
								, @om_nDeleted int		/*deleted char check*/
								, @om_nAutoStat int		/*auto stats*/
								, @om_nRebirthLevel int		/*Rebirth*/
								, @om_nSelectedBag int	/*Bag Loot*/
								, @om_dwPetfilter bigint /*Petfilter DB*/
								, @om_szPetfilterLists varchar(4096)	/*Petfilter Lists*/
				...
				INSERT CHARACTER_TBL
							(
								...
								, m_ncR				/*Name Color Change*/
								, m_ncG				/*Name Color Change*/
								, m_ncB				/*Name Color Change*/
								, m_nCollectingTime /*Achievement Collecting*/
								, m_nLastOnline		/*last online*/
								, m_nOnlineTime		/*online time*/
								, m_nCraftingExp	/*crafting exp*/
								, m_nDeleted		/*deleted char check*/
								, m_nAutoStat		/*auto stats*/
								, m_nRebirthLevel	/*Rebirth*/
								, m_nSelectedBag 	/*Bag Loot*/
								, m_dwPetfilter 	/*Petfilter DB*/
								, m_szPetfilterLists /*Petfilter Lists*/
							)
				VALUES
							(
								@om_idPlayer,
							...
							, -1	/*Name Color Change*/
							, -1	/*Name Color Change*/
							, 0		/*Achievement Collecting*/
							, 0		/*last online*/
							, 0		/*online time*/
							, 0		/*crafting exp*/
							, 0		/*deleted char check*/
							, 0		/*auto stats*/
							, 0		/*Rebirth*/
							, 0 	/*Bag Loot*/
							, 0 	/*Petfilter DB*/
