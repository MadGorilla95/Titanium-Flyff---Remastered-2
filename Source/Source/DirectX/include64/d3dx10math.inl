...
D3DX10INLINE D3DXVECTOR4::operator D3DXVECTOR3 ()
{
	return D3DXVECTOR3(x, y, z);
}

D3DX10INLINE D3DXVECTOR4& D3DXVECTOR4::operator = (CONST D3DXVECTOR3& v)
{
	x += v.x;
	y += v.y;
	z += v.z;
...
D3DX10INLINE float D3DXVec3LengthSq(D3DXVECTOR3 &&pV)
{
	return pV.x * pV.x + pV.y * pV.y + pV.z * pV.z;
}
...
D3DX10INLINE void D3DXVec3Cross(D3DXVECTOR3& pOut, D3DXVECTOR3 &&pV1, D3DXVECTOR3 &&pV2)
{
	D3DXVECTOR3 v;
#ifdef D3DX_DEBUG
	if (!pV1 || !pV2) return;
