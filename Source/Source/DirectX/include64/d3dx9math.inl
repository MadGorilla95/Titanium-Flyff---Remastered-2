...
D3DXINLINE D3DXVECTOR4::operator D3DXVECTOR3 ()
{
	return D3DXVECTOR3(x, y, z);
}

D3DXINLINE D3DXVECTOR4& D3DXVECTOR4::operator = (CONST D3DXVECTOR3& v)
{
	x += v.x;
	y += v.y;
	z += v.z;
...
__forceinline  D3DXVECTOR2* D3DXVec2Subtract
    ( D3DXVECTOR2 *pOut, CONST D3DXVECTOR2 *pV1, CONST D3DXVECTOR2 *pV2 )
{
#ifdef D3DX_DEBUG
    if(!pOut || !pV1 || !pV2)
...
__forceinline  D3DXVECTOR2* D3DXVec2Minimize
    ( D3DXVECTOR2 *pOut, CONST D3DXVECTOR2 *pV1, CONST D3DXVECTOR2 *pV2 )
{
#ifdef D3DX_DEBUG
    if(!pOut || !pV1 || !pV2)
...
__forceinline  D3DXVECTOR2* D3DXVec2Maximize
    ( D3DXVECTOR2 *pOut, CONST D3DXVECTOR2 *pV1, CONST D3DXVECTOR2 *pV2 )
{
#ifdef D3DX_DEBUG
    if(!pOut || !pV1 || !pV2)
...
__forceinline  D3DXVECTOR2* D3DXVec2Scale
...
__forceinline float D3DXVec3Length(D3DXVECTOR3&& pV)
{
    return sqrtf(pV.x * pV.x + pV.y * pV.y + pV.z * pV.z);
}
...
__forceinline float D3DXVec3LengthSq(D3DXVECTOR3 &&pV)
{
	return pV.x * pV.x + pV.y * pV.y + pV.z * pV.z;
}
...
__forceinline void D3DXVec3Cross(D3DXVECTOR3& pOut, D3DXVECTOR3 &&pV1, D3DXVECTOR3 &&pV2)
{
	D3DXVECTOR3 v;
...
__forceinline D3DXVECTOR3* D3DXVec3Lerp(D3DXVECTOR3 *pOut, const D3DXVECTOR3 *pV1, const D3DXVECTOR3 *pV2, float s)
{
    pOut->x = pV1->x + s * (pV2->x - pV1->x);
    pOut->y = pV1->y + s * (pV2->y - pV1->y);
