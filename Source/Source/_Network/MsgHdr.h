...
#define PACKETTYPE_SELECT_TMP_CLASS 				(DWORD)0x88101242
#define PACKETTYPE_SAVEEQUIPPRESET 					(DWORD)0x88101243
#define PACKETTYPE_GETEQUIPPRESETS 					(DWORD)0x88101244
...
#define PACKETTYPE_BUYITEMCART							(DWORD)0xAA000013		
#define PACKETTYPE_INVENTORY							(DWORD)0xAA000014

#ifdef __SYS_LOCK_ITEM
#define	PACKETTYPE_LOCK_ITEM							(DWORD)0x88100242
#endif //__SYS_LOCK_ITEM

#ifdef __WIKIPEDIA_ITEMS
#define	PACKETTYPE_WIKICI								(DWORD)0x88100243
#endif //__WIKIPEDIA_ITEMS

#ifdef __AEGON_PETMISTAKE
#define	PACKETTYPE_PET_TAMER_MISTAKE_CUSTOM				(DWORD)0x88100244
#endif // __AEGON_PETMISTAKE

#ifdef __AEGON_MONSTER_HUNT
#define PACKETTYPE_SENDLOADMHPROGRESS					(DWORD)0x88100246
#endif // __AEGON_MONSTER_HUNT

#ifdef __AEGON_COUNT_DIFF_IP
#define	PACKETTYPE_GETDIFFPLAYER						(DWORD)0x88100247
#endif // __AEGON_COUNT_DIFF_IP

#ifdef __PARTY_ASSISTANT	
#define PACKETTYPE_ASSISTANT							(DWORD)0x88100248
#endif //__PARTY_ASSISTANT

#ifdef __LEEAEG_SHOP_FINDER
#define PACKETTYPE_SEND_SHOP_ITEM_TELE					(DWORD)0x88100249
#define PACKETTYPE_SEND_SHOP_ITEM_REFRESH				(DWORD)0x88100250
#endif // __LEEAEG_SHOP_FINDER

#ifdef __GIFTBOX_LIST_ITEMS
#define PACKETTYPE_GIFTBOX_PREVIEW						(DWORD)0x88100251
#endif //__GIFTBOX_LIST_ITEMS

#ifdef __AEGON_RETURN_AWAKE
#define PACKETTYPE_RETURN_AWAKENING						(DWORD)0x88100252
#endif // __AEGON_RETURN_AWAKE

#ifdef __VENDING_NPC
#define PACKETTYPE_CREATEVENDOR							(DWORD)0x88100253
#define PACKETTYPE_ADDVENDORNPC							(DWORD)0x88100254
#define PACKETTYPE_REMOVEVENDORNPC						(DWORD)0x88100255
#define PACKETTYPE_UPDATEVENDORNPC						(DWORD)0x88100256
#define PACKETTYPE_GETVENDORNPC							(DWORD)0x88100257
#define PACKETTYPE_UNLINKNPCVENDOR						(DWORD)0x88100258
#define PACKETTYPE_ADDVENDORNPCLOG						(DWORD)0x88100259
#define PACKETTYPE_REMOVEVENDORNPCLOG					(DWORD)0x88100260
#define PACKETTYPE_SHOPCLOSELOG							(DWORD)0x88100261
#endif // __VENDING_NPC

#ifdef __AEGON_CONVERT_PERIN
#define PACKETTYPE_AEGON_CONVERT_PERIN					(DWORD)0x88100262
#endif // __AEGON_CONVERT_PERIN

#ifdef __NEW_CHANGE_JOB
#define	PACKETTYPE_SEND_JOB_CHANGE						(DWORD)0x88100263
#endif // __NEW_CHANGE_JOB

#ifdef __WEAPON_RARITY
#define	PACKETTYPE_WEAPON_RARITY						(DWORD)0x88100264
#endif // __WEAPON_RARITY

#ifdef __HIDE_FASHION
#define PACKETTYPE_HIDE_COAT							(DWORD)0x88100265
#endif // __HIDE_FASHION

#ifdef __SYS_CUSTOM_TITLE
#define PACKETTYPE_CREATE_OWN_TITLE						(DWORD)0x88100266
#define PACKETTYPE_UPDATE_SHOW_TITLE					(DWORD)0x88100267
#endif //__SYS_CUSTOM_TITLE

#ifdef __MOUNT
#define PACKETTYPE_UPDATE_MOUNT							(DWORD)0x88100277
#endif //__MOUNT

#ifdef __PREMIUM
#define PACKETTYPE_UPDATE_SHOW_PREMIUM					(DWORD)0x88100278
#endif //__PREMIUM

#ifdef __SYS_PARTYFINDER
#define PACKETTYPE_JOIN_PARTY_REQ						(DWORD)0x88100279
#define PACKETTYPE_PARTYALLOWJOIN						(DWORD)0x88100280
#endif // __SYS_PARTYFINDER

#ifdef __ANARCHY_SYSTEM
#define	PACKETTYPE_ANARCHY_BUFFS						(DWORD)0x88100281
#define	PACKETTYPE_ANARCHY_REQUEST						(DWORD)0x88100282
#endif // __ANARCHY_SYSTEM

#ifdef __AEGON_TELEPORTER
#define PACKETTYPE_APP_TELEPORT							(DWORD)0x88100283
#endif

#ifdef __AEGON_LOOT_BOX
#define PACKETTYPE_LOOTBOX_REFRESH						(DWORD)0x88100284
#define PACKETTYPE_LOOTBOX_START						(DWORD)0x88100285
#define PACKETTYPE_LOOTBOX_COLLECT						(DWORD)0x88100286
#endif // __AEGON_LOOT_BOX

#ifdef __STOP_EXP
#define	PACKETTYPE_SETEXPSTOP							(DWORD)0x88100287
#endif //__STOP_EXP

#ifdef __AEGON_VIEW_INV
#define	PACKETTYPE_VIEW_INVENTORY						(DWORD)0x88100292
#define	PACKETTYPE_VIEW_INVENTORY_COMMAND				(DWORD)0x88100293
#endif // __AEGON_VIEW_INV

#ifdef __SYS_PETFILTER
#define	PACKETTYPE_PETFILTER							(DWORD)0x88100294
#endif //__SYS_PETFILTER

#ifdef __BADGE
#define	PACKETTYPE_BADGE_CHANGE							(DWORD)0x88100295
#endif //__BADGE

#ifdef __AEGON_INGAME_DP
#define	PACKETTYPE_DP_COMMAND							(DWORD)0x88100296
#endif // __AEGON_INGAME_DP

#ifdef __SYS_GUILDCOLOR
#define PACKETTYPE_SETGUILDCOLOR						(DWORD)0x88100297
#define PACKETTYPE_SETGUILDCOLOR_CTS					(DWORD)0x88100298
#endif //__SYS_GUILDCOLOR

#ifdef __GUILDFINDER
#define PACKETTYPE_WC_GUILDFINDER						(DWORD)0x88100299
#define PACKETTYPE_CD_GUILD_FINDER						(DWORD)0x88100300
#define PACKETTYPE_CW_GUILDFINDER						(DWORD)0x88100301
#define PACKETTYPE_GUILD_LIST							(DWORD)0x88100302
#define PACKETTYPE_GUILD_REQUEST						(DWORD)0x88100303
#define PACKETTYPE_NW_GUILDFINDER						(DWORD)0x88100304
#endif //__GUILDFINDER

#ifdef	__REMOVE_DURATION_ITEMS
#define PACKETTYPE_REMOVE_CMM							(DWORD)0x88100305
#endif	//__REMOVE_DURATION_ITEMS

#ifdef __SYS_MONSTER_CLASH
#define PACKETTYPE_MONSTER_CLASH_REGISTER_WINDOW		 (DWORD)0x88100306
#define PACKETTYPE_MONSTER_CLASH_REGISTER_MEMBER_WINDOW	 (DWORD)0x88100307
#define PACKETTYPE_MONSTER_CLASH_REGISTER				 (DWORD)0x88100308
#define PACKETTYPE_MONSTER_CLASH_REGISTER_MEMBER		 (DWORD)0x88100309
#define PACKETTYPE_MONSTER_CLASH_UNREGISTER_MEMBER		 (DWORD)0x88100310
#endif //__SYS_MONSTER_CLASH

#ifdef __REPORT_SYSTEM
#define	PACKETTYPE_SENDREPORT							(DWORD)0x88100311
#endif // __REPORT_SYSTEM

#ifdef __SYS_SANDBOX
#define	PACKETTYPE_SANDBOX								(DWORD)0x88100312
#define	PACKETTYPE_SANDBOX_TELEPORT						(DWORD)0x88100313
#endif //__SYS_SANDBOX

#ifdef __CHECKLOAD
#define	PACKETTYPE_REQUEST_CHECKLOAD 					(DWORD)0x88100314
#endif //__CHECKLOAD

#ifdef __TIMER
#define PACKETTYPE_TIMER 								(DWORD)0x88100315
#endif //__TIMER

#ifdef __AEGON_ACHIEVEMENT_SYSTEM
#define PACKETTYPE_SENDLOADACHIEVEMENTPROG				(DWORD)0x88100316
#define PACKETTYPE_ONCHECKACHIEVEMENTPROG				(DWORD)0x88100317
#define PACKETTYPE_SENDCOLLECTACHIEVEMENT				(DWORD)0x88100318
#define PACKETTYPE_SENDACHIEVEMENTFAV					(DWORD)0x88100319
#endif // __AEGON_ACHIEVEMENT_SYSTEM

#ifdef __AEGON_FULLSCREEN_AND_RESIZE
#define PACKETTYPE_SENDRELOADTASKBAR					(DWORD)0x88100320
#endif // __AEGON_FULLSCREEN_AND_RESIZE

#ifdef __SYS_NAMECOLOR
#define	PACKETTYPE_SETNAMECOLOR							(DWORD)0x88100321
#endif //__SYS_NAMECOLOR

#ifdef __AEGON_LAST_ONLINE
#define	PACKETTYPE_LASTONLINE_INIT_LOAD					(DWORD)0x88100322
#endif // __AEGON_LAST_ONLINE

#ifdef __PLAYER_LIST 
#define	PACKETTYPE_PLAYER_LIST_SEND_REQUEST				(DWORD)0x88100323
#endif // __PLAYER_LIST

#ifdef __BAN_SYSTEM
#define	PACKETTYPE_BAN_ACCOUNT							(DWORD)0x88100325
#endif // __BAN_SYSTEM

#ifdef __AEGON_ACHIEVEMENT_SYSTEM
#define PACKETTYPE_UPDATEACHIEVEMENTOFFLINE				(DWORD)0x88100327
#endif // __AEGON_ACHIEVEMENT_SYSTEM

#ifdef __AEGON_CRAFTING_SYSTEM
#define PACKETTYPE_SENDCRAFTRECIPE						(DWORD)0x88100328
#endif // __AEGON_CRAFTING_SYSTEM

#ifdef __WEAPON_MERGE
#define PACKETTYPE_WEAPONMERGE							(DWORD)0x88100329
#define PACKETTYPE_WEAPONMERGE_CANCEL					(DWORD)0x88100330
#endif //__WEAPON_MERGE

#ifdef __NPC_BUFF_CLASS
#define PACKETTYPE_NPC_BUFF_CLASS                		(DWORD)0x88100331
#endif //__NPC_BUFF_CLASS

#ifdef __BUYBACK
#define PACKETTYPE_SEND_BUYBACK							(DWORD)0x88100332
#endif // __BUYBACK

#ifdef __AEGON_SEASON_PASS
#define PACKETTYPE_SENDLOADSEASONPASSPROG				(DWORD)0x88100333
#define PACKETTYPE_SENDCLAIMSEASONPASSREWARD			(DWORD)0x88100334
#define PACKETTYPE_SENDGETSEASONPASSCOUNTDOWN			(DWORD)0x88100335
#define PACKETTYPE_SENDPURCHASESEASONPASS				(DWORD)0x88100336
#endif // __AEGON_SEASON_PASS

#ifdef __SYS_MAP_BUFFS
#define PACKETTYPE_CHECK_MAPBUFFS						(DWORD)0x88100337
#endif //__SYS_MAP_BUFFS

#ifdef __AEGON_ADVANCED_ANNOUNCEMENT
#define PACKETTYPE_SENDAEGONSYSTEMSHOUT					(DWORD)0x88100338
#endif // __AEGON_ADVANCED_ANNOUNCEMENT

#ifdef __SWITCH_EQUIP
#define PACKETTYPE_EQUIPSWITCH_UPDATE					(DWORD)0x88100339
#define PACKETTYPE_EQUIPSWITCH_USE						(DWORD)0x88100340
#endif // __SWITCH_EQUIP

#ifdef __AEGON_PVP_RANKING
#define PACKETTYPE_PVPRANKING_INIT_LOAD					(DWORD)0x88100341
#define PACKETTYPE_PVPRANKING_SAVE						(DWORD)0x88100342
#define PACKETTYPE_GET_PVP_RANKING						(DWORD)0x88100343
#endif // __AEGON_PVP_RANKING

#ifdef __AEGON_PREM_MOTIONS
#define PACKETTYPE_SENDPURCHASEMOTION					(DWORD)0x88100344
#endif // __AEGON_PREM_MOTIONS

#ifdef __PET_GLOW
#define PACKETTYPE_CHANGEPETGLOW						(DWORD)0x88100345
#endif // __PET_GLOW

#ifdef __MODS_MANAGER
#define PACKETTYPE_SEND_MODS_MANAGER					(DWORD)0x88100346
#endif // __MODS_MANAGER

#ifdef __SYS_WORLDBOSS
#define PACKETTYPE_REGISTER_HWID						(DWORD)0x88100347
#endif //__SYS_WORLDBOSS

#ifdef __NPC_QUICK_SELL
#define PACKETTYPE_QUICKSELL							(DWORD)0x88100348
#endif //__NPC_QUICK_SELL

#ifdef __WORLSERVER_MENU
#define PACKETTYPE_EXCHANGE_SETAPPLY					(DWORD)0x88100349
#define PACKETTYPE_CHAT_SETAPPLY						(DWORD)0x88100350
#define PACKETTYPE_PK_SETAPPLY							(DWORD)0x88100351
#endif //__WORLSERVER_MENU

#ifdef __AEGON_EMOTE_SYSTEM
#define PACKETTYPE_SENDPURCHASEEMOTE					(DWORD)0x88100352
#endif //__AEGON_EMOTE_SYSTEM

#ifdef __CRYSTAL
#define PACKETTYPE_CRYSTAL								(DWORD)0x88100353
#endif //__CRYSTAL

#ifdef __AEGON_INGAME_SHOP
#define PACKETTYPE_INGAMESHOP_INIT_LOAD					(DWORD)0x88100354
#define PACKETTYPE_SENDWEBSHOPPURCHASE					(DWORD)0x88100355
#endif

#ifdef __AEGON_TOURNAMENT
#define PACKETTYPE_SENDCREATETOURNAMENT					(DWORD)0x88100356
#define PACKETTYPE_TOURNAMENT_DB_LOAD					(DWORD)0x88100357
#define PACKETTYPE_TOURNAMENT_DB_SAVE					(DWORD)0x88100358
#define PACKETTYPE_TOURNAMENT_GET_MAP					(DWORD)0x88100359
#endif // __AEGON_TOURNAMENT

#ifdef __ROYAL_RUMBLE
#define PACKETTYPE_PLAYERWAR_SAVE						(DWORD)0x88100360
#define PACKETTYPE_PLAYERWAR_LOAD						(DWORD)0x88100361
#define PACKETTYPE_PLAYERWAR_JOIN						(DWORD)0x88100362
#define PACKETTYPE_PLAYERWAR_RANKING					(DWORD)0x88100363
#endif // __ROYAL_RUMBLE

#ifdef __AEGON_AUTO_STATS
#define PACKETTYPE_UPDATE_AUTO_STATS					(DWORD)0x88100364
#endif //__AEGON_AUTO_STATS

#ifdef __AEGON_F_TOOL
#define PACKETTYPE_UPDATE_FTOOLS						(DWORD)0x88100365
#endif //__AEGON_F_TOOL

#ifdef __REMOVE_SKILL_BUFF
#define	PACKETTYPE_REMOVE_SKILL_BUFF					(DWORD)0x88100366
#endif // __REMOVE_SKILL_BUFF

#ifdef __AEGON_TOURNAMENT
#define PACKETTYPE_SENDDELETETOURNAMENT					(DWORD)0x88100367
#endif //__AEGON_TOURNAMENT

#ifdef __AEGON_TIME_DIFF
#define PACKETTYPE_UPDATE_TIME_DIFF						(DWORD)0x88100368
#endif //__AEGON_TIME_DIFF

#ifdef __FL_BAG_LOOT
#define PACKETTYPE_SELECTED_BAG 						(DWORD)0x88100369
#endif //__FL_BAG_LOOT

#ifdef __FL_BAG_UPDATE
#define PACKETTYPE_DOUSEITEM_BAG						(DWORD)0x88100370
#endif //__FL_BAG_UPDATE

#ifdef __AEGON_PVP_MINIGAMES
#define PACKETTYPE_PVPMINIGAME_CREATE					(DWORD)0x88100371
#define PACKETTYPE_PVPMINIGAME_COMMAND					(DWORD)0x88100372
#define PACKETTYPE_PVPMINIGAME_CHAT						(DWORD)0x88100373
#define PACKETTYPE_PVPMINIGAME_GET_LIST					(DWORD)0x88100374
#endif

#ifdef __AEGON_MESSENGER
#define PACKETTYPE_MESSENGER_STATUS_UPDATE				(DWORD)0x88100375
#define PACKETTYPE_MESSENGER_ADD_CHAT_UNIT				(DWORD)0x88100376
#endif

#ifdef __AEGON_BAG_FREE_MOVE
#define PACKETTYPE_MOVE_POCKET_ITEM						(DWORD)0x88100377
#endif
...
#define SNAPSHOTTYPE_TAX_ALLINFO				(WORD)0x0402
...
#define SNAPSHOTTYPE_FF_SET_POSITION_INFO			(WORD)0x8914

#ifdef __AEGON_MONSTER_HUNT
#define SNAPSHOTTYPE_ADDMHPROGRESS					(WORD)0x8917
#endif // __AEGON_MONSTER_HUNT

#ifdef __PARTY_ASSISTANT
#define SNAPSHOTTYPE_ASSIST_CLIENT					(WORD)0x8918
#endif //__PARTY_ASSISTANT

#ifdef __LEEAEG_SHOP_FINDER
#define SNAPSHOTTYPE_ADD_SHOP_FINDER_REFRESH		(WORD)0x8919
#endif // __LEEAEG_SHOP_FINDER

#ifdef __GIFTBOX_LIST_ITEMS
#define	SNAPSHOTTYPE_GIFTBOX_PREVIEW				(WORD)0x8920
#endif // __GIFTBOX_LIST_ITEMS

#ifdef __VENDING_NPC
#define SNAPSHOTTYPE_NPCVENDOR_LINK					(WORD)0x8921
#define SNAPSHOTTYPE_NPCVENDOR_UNLINK				(WORD)0x8922
#endif // __VENDING_NPC

#ifdef __DROP_LOG
#define SNAPSHOTTYPE_REAP_GOLD						(WORD)0x8923
#endif // __DROP_LOG

#ifdef __WEAPON_RARITY
#define	SNAPSHOTTYPE_WEAPON_RARITY					(WORD)0x8924
#endif // __WEAPON_RARITY

#ifdef __HIDE_FASHION
#define	SNAPSHOTTYPE_HIDE_COAT						(WORD)0x8925
#endif // __HIDE_FASHION

#ifdef __SYS_CUSTOM_TITLE
#define	SNAPSHOTTYPE_UPDATE_TITLE					(WORD)0x8926
#endif // __SYS_CUSTOM_TITLE

#ifdef __MOUNT
#define SNAPSHOTTYPE_UPDATE_MOUNT					(WORD)0x8936
#endif // __MOUNT

#ifdef __PREMIUM
#define	SNAPSHOTTYPE_UPDATE_PREMIUM					(WORD)0x8937
#endif // __PREMIUM

#ifdef __HEAL_SHOW
#define	SNAPSHOTTYPE_HEAL_DAMAGE					(WORD)0x8938
#endif // __HEAL_SHOW

#ifdef __SYS_PARTYFINDER
#define SNAPSHOTTYPE_PARTYFINDER_REFRESH			(WORD)0x8939
#define SNAPSHOTTYPE_PARTYALLOWJOIN					(WORD)0x8940
#endif // __SYS_PARTYFINDER

#ifdef __ANARCHY_SYSTEM
#define SNAPSHOTTYPE_ANARCHY_REQUEST				(WORD)0x8941
#endif // __ANARCHY_SYSTEM

#ifdef __AEGON_LOOT_BOX
#define SNAPSHOTTYPE_LOOTBOX_REFRESH				(WORD)0x8942
#define SNAPSHOTTYPE_LOOTBOX_RESULT					(WORD)0x8943
#endif // __AEGON_LOOT_BOX

#ifdef __AEGON_VIEW_INV
#define	SNAPSHOTTYPE_ADD_VIEW_INV					(WORD)0x8949
#endif // __AEGON_VIEW_INV

#ifdef __BADGE
#define	SNAPSHOTTYPE_BADGE_UPDATE					(WORD)0x8950
#define	SNAPSHOTTYPE_BADGE_CHANGE					(WORD)0x8951
#endif //__BADGE

#ifdef __AEGON_INGAME_DP
#define	SNAPSHOTTYPE_DP_REFRESH						(WORD)0x8952
#endif // __AEGON_INGAME_DP

#ifdef __GUILDFINDER
#define SNAPSHOTTYPE_GUILD_FINDER_OPT				(WORD)0x8953
#define SNAPSHOTTYPE_GUILDFINDER_LIST				(WORD)0x8954
#define SNAPSHOTTYPE_GUILDFINDER_APPLICATION		(WORD)0x8955
#endif //__GUILDFINDER

#ifdef __SYS_MONSTER_CLASH
#define SNAPSHOTTYPE_MONSTER_CLASH_REGISTER_WINDOW			 (WORD)0x8956
#define SNAPSHOTTYPE_MONSTER_CLASH_REGISTER_MEMBER_WINDOW	 (WORD)0x8957
#define SNAPSHOTTYPE_MONSTER_CLASH_REGISTER					 (WORD)0x8958
#define SNAPSHOTTYPE_MONSTER_CLASH_REGISTER_MEMBER			 (WORD)0x8959
#define SNAPSHOTTYPE_MONSTER_CLASH_UNREGISTER_MEMBER		 (WORD)0x8960
#define SNAPSHOTTYPE_MONSTER_CLASH_STATE					 (WORD)0x8961
#endif //__SYS_MONSTER_CLASH

#ifdef __SHOPS_VISITED
#define SNAPSHOTTYPE_REMOVE_SHOP							(WORD)0x8962
#endif //__SHOPS_VISITED

#ifdef __TICKETS_DETAILS
#define SNAPSHOTTYPE_TICKETDETAIL           				(WORD)0x8963
#endif //__TICKETS_DETAILS

#ifdef __CHECKLOAD
#define SNAPSHOTTYPE_CHECKLOAD								(WORD)0x8964
#endif //__CHECKLOAD

#ifdef __TIMER
#define SNAPSHOTTYPE_TIMER									(WORD)0x8965
#endif //__TIMER

#ifdef __AEGON_ACHIEVEMENT_SYSTEM
#define SNAPSHOTTYPE_ADDACHIEVEMENTPROGRESS					(WORD)0x8966
#define SNAPSHOTTYPE_ADDFINISHEDACHIEVEMENT					(WORD)0x8967
#define SNAPSHOTTYPE_ADDFAVACHIEVEMENTREFRESH				(WORD)0x8968
#endif // __AEGON_ACHIEVEMENT_SYSTEM

#ifdef __UPGRADE_SUCCESS
#define SNAPSHOTTYPE_UPGRADE_SUCCESS						(WORD)0x8969
#endif // __UPGRADE_SUCCESS

#ifdef __AFK_MONITORING
#define SNAPSHOTTYPE_SEND_AFKSTATE							(WORD)0x8970
#endif //__AFK_MONITORING

#ifdef __SYS_NAMECOLOR
#define	SNAPSHOTTYPE_SETNAMECOLOR							(WORD)0x8972
#endif //__SYS_NAMECOLOR

#ifdef __AEGON_ACHIEVEMENT_SYSTEM
#define SNAPSHOTTYPE_ADDCOLLECTINGTIMEREFRESH				(WORD)0x8973
#endif // __AEGON_ACHIEVEMENT_SYSTEM

#ifdef __AEGON_LAST_ONLINE
#define SNAPSHOTTYPE_ADDLASTONLINEREFRESH					(WORD)0x8974
#define SNAPSHOTTYPE_ADDSINGLELASTONLINEREFRESH				(WORD)0x8975
#define SNAPSHOTTYPE_ADDOWNLASTONLINEREFRESH				(WORD)0x8976
#endif // __AEGON_LAST_ONLINE

#ifdef __AEGON_INGAME_TIME
#define SNAPSHOTTYPE_ADDONLINETIMEREFRESH					(WORD)0x8977
#endif // __AEGON_INGAME_TIME

#ifdef __PLAYER_LIST
#define	SNAPSHOTTYPE_PLAYER_LIST							(WORD)0x8978
#endif // __PLAYER_LIST

#ifdef __AEGON_CRAFTING_SYSTEM
#define	SNAPSHOTTYPE_CRAFTING_SUCCESS						(WORD)0x8981
#define	SNAPSHOTTYPE_CRAFTING_EXP_REFRESH					(WORD)0x8982
#endif // __AEGON_CRAFTING_SYSTEM

#ifdef __WEAPON_MERGE
#define SNAPSHOTTYPE_MERGEWEAPON							(WORD)0x8983
#endif //__WEAPON_MERGE

#ifdef __BUYBACK
#define	SNAPSHOTTYPE_BUYBACK								(WORD)0x8984
#define	SNAPSHOTTYPE_BUYBACK_REMOVE_ITEM					(WORD)0x8985
#endif // __BUYBACK

#ifdef __CLIENT_ONLINE_COUNT
#define SNAPSHOTTYPE_PLAYER_COUNT							(WORD)0x8986
#endif //__CLIENT_ONLINE_COUNT

#ifdef __AEGON_SEASON_PASS
#define SNAPSHOTTYPE_ADDSEASONPASSPROGRESS					(WORD)0x8987
#define SNAPSHOTTYPE_ADDSEASONPASSUPDATE					(WORD)0x8988
#define SNAPSHOTTYPE_ADDSEASONPASSCOUNTDOWN					(WORD)0x8989
#endif // __AEGON_SEASON_PASS

#ifdef __SWITCH_EQUIP
#define SNAPSHOTTYPE_EQUIPSWITCH_UPDATE						(WORD)0x8990
#endif // __SWITCH_EQUIP

#ifdef __AEGON_PVP_RANKING
#define SNAPSHOTTYPE_ADD_PVP_RANKING						(WORD)0x8991
#endif // __AEGON_PVP_RANKING

#ifdef __AEGON_PERMANENT_BUFF
#define SNAPSHOTTYPE_ADD_PERM_BUFF							(WORD)0x8992
#endif // __AEGON_PERMANENT_BUFF

#ifdef __AEGON_PREM_MOTIONS
#define SNAPSHOTTYPE_ADD_MOTION_REFRESH						(WORD)0x8993
#endif // __AEGON_PREM_MOTIONS

#ifdef __INFO_DUNGEONS
#define SNAPSHOTTYPE_DUNGEON_INFOLIST						(WORD)0x8994
#endif //__INFO_DUNGEONS

#ifdef __PET_GLOW
#define SNAPSHOTTYPE_PETGLOW_CHANGESFX						(WORD)0x8995
#endif // __PET_GLOW

#ifdef __COMBAT_LOG
#define SNAPSHOTTYPE_CLEARLOG								(WORD)0x8996
#endif //__COMBAT_LOG

#ifdef __AEGON_EMOTE_SYSTEM
#define SNAPSHOTTYPE_ADD_EMOTE_REFRESH						(WORD)0x8997
#endif //__AEGON_EMOTE_SYSTEM

#ifdef __LEEAEG_SYSTEM_INDIVIDUAL
#define SNAPSHOTTYPE_SYSTEM_TEXT							(WORD)0x8998
#endif //__LEEAEG_SYSTEM_INDIVIDUAL

#ifdef __CRYSTAL
#define SNAPSHOTTYPE_CRYSTAL								(WORD)0x8999
#endif //__CRYSTAL

#ifdef __AEGON_INGAME_SHOP
#define SNAPSHOTTYPE_INGAME_SHOP_INFO						(WORD)0x9005
#endif //__AEGON_INGAME_SHOP

#ifdef __AEGON_TOURNAMENT
#define SNAPSHOTTYPE_TOURNAMENT_MAP							(WORD)0x9006
#endif // __AEGON_TOURNAMENT

#ifdef __ROYAL_RUMBLE
#define SNAPSHOTTYPE_SIEGE_WAR								(WORD)0x9007
#define SNAPSHOTTYPE_PLAYERWAR_UPDATE						(WORD)0x9008
#endif //__ROYAL_RUMBLE

#ifdef __AEGON_AUTO_STATS
#define SNAPSHOTTYPE_AUTO_STATS								(WORD)0x9009
#endif //__AEGON_AUTO_STATS

#ifdef __AEGON_F_TOOL
#define SNAPSHOTTYPE_FTOOL_UPDATE							(WORD)0x9010
#endif //__AEGON_F_TOOL

#ifdef __SYS_REBIRTH
#define SNAPSHOTTYPE_REBIRTH_LEVEL							(WORD)0x9011
#endif //__SYS_REBIRTH	

#ifdef __AEGON_TOURNAMENT
#define SNAPSHOTTYPE_TOURNAMENTS_CHANGED					(WORD)0x9012
#endif //__AEGON_TOURNAMENT

#ifdef __AEGON_TIME_DIFF
#define SNAPSHOTTYPE_UPDATE_TIME_DIFF						(WORD)0x9013
#endif //__AEGON_TIME_DIFF

#ifdef __NEW_SFX_WINGS
#define SNAPSHOTTYPE_WING_SFX								(WORD)0x9014
#endif // __NEW_SFX_WINGS

#ifdef __FL_BAG_LOOT
#define SNAPSHOTTYPE_ADD_CLIENT_BAG 						(WORD)0x9015
#endif //__FL_BAG_LOOT

#ifdef __AEGON_PVP_MINIGAMES
#define SNAPSHOTTYPE_ADD_PVPMINIGAME_INVITE					(WORD)0x9016
#define SNAPSHOTTYPE_ADD_PVPMINIGAME_REFRESH				(WORD)0x9017
#define SNAPSHOTTYPE_ADD_PVPMINIGAME_CHAT					(WORD)0x9018
#define SNAPSHOTTYPE_ADD_PVPMINIGAME_LIST					(WORD)0x9019
#endif

#ifdef __MIKSIK_EQUALIZED_MODE
#define SNAPSHOTTYPE_SELECT_TMP_CLASS  						(WORD)0x9020
#define SNAPSHOTTYPE_SERIALIZE_INVENTORY 					(WORD)0x9021
#define SNAPSHOTTYPE_ADDUPDATEEQUIPFORNEAR 					(WORD)0x9022
#endif

#ifdef __AEGON_IMPROVED_SHOPDESIGN
#define SNAPSHOTTYPE_ADD_VENDOR_SHOPDESIGN					(WORD)0x9023
#endif

#ifdef __AEGON_MESSENGER
#define SNAPSHOTTYPE_ADD_MESSENGER_UPDATE					(WORD)0x9024
#define SNAPSHOTTYPE_ADD_MESSENGER_CHAT_UNIT				(WORD)0x9025
#endif

#ifdef __AEGON_VIEW_INV
#define	SNAPSHOTTYPE_ADD_VIEW_BAG					(WORD)0x9026
#define	SNAPSHOTTYPE_ADD_VIEW_BANK					(WORD)0x9027
#endif // __AEGON_VIEW_INV

#ifdef __SYS_LOCK_ITEM
#define	SNAPSHOTTYPE_ADD_ITEM_LOCK					(WORD)0x9028
#endif

#ifdef __MAX_COLLECT_BY_IP
#define	SNAPSHOTTYPE_ADD_COLL_STATUS				(WORD)0x9029
#endif

#ifdef __STOP_EXP
#define	SNAPSHOTTYPE_ADD_EXP_STATE					(WORD)0x9030
#endif

#ifdef __AEGON_BAG_FREE_MOVE
#define	SNAPSHOTTYPE_MOVE_POCKET_ITEM				(WORD)0x9031
#endif
...
#define	PN_CERTIFIER	SERVER_CERT_PORT
...
#define	PN_LOGINSRVR	SERVER_LOGIN_PORT
...
#define GAME_RATE_PIECE_ITEMDROP		(BYTE)0x15
#endif 
...
#ifdef __ROYAL_RUMBLE
const BYTE WAR_ADDJOINTIME = 0x00;
const BYTE WAR_ADDCLIENTUPDATE = 0x01;
const BYTE WAR_ADDFIGHTSTATE = 0x02;
const BYTE WAR_REJOIN_WINDOW = 0x03;
const BYTE WAR_ENDWAR = 0x04;
const BYTE WAR_ADDRANKING = 0x05;
const BYTE WAR_ADDREGISTERLIST = 0x06;
#endif //__ROYAL_RUMBLE