...
public:
	...
	void	OnTradelastConfirm( CAr & ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize );
...
#ifdef __STOP_EXP
	void	OnSetExpStop(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
#endif //__STOP_EXP
...
//	void	OnPlayerDestAngle( CAr & ar, CUser* pUser );
	...
	void OnNPCBuffClass(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
...
#ifdef __VENDING_NPC
	BOOL	ClosePVendor(CUser* pUser, OBJID objidVendor, BOOL bClearShop);
#else // __VENDING_NPC
...
private:
	...
	void	OnItemLock(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
#endif // __SYS_LOCK_ITEM

#ifdef __WIKIPEDIA_ITEMS
	void	OnWikiCreateItem(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
#endif //__WIKIPEDIA_ITEMS

#ifdef __AEGON_PETMISTAKE
	void	OnPetTamerMistakeCustom(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
#endif // __AEGON_PETMISTAKE

#ifdef __AEGON_MONSTER_HUNT
	void OnLoadMonsterHuntProgress(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
#endif // __AEGON_MONSTER_HUNT

#ifdef __LEEAEG_SHOP_FINDER
	void OnShopItemTele(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
	void OnShopItemRefresh(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
#endif // __LEEAEG_SHOP_FINDER

#ifdef __GIFTBOX_LIST_ITEMS
	void	OnGiftboxQuery(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
#endif // __GIFTBOX_LIST_ITEMS

#ifdef __AEGON_RETURN_AWAKE
void	OnReturnAwakening(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
#endif // __AEGON_RETURN_AWAKE

#ifdef __VENDING_NPC
void    OnCreateVendor(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
void    OnUnlinkNpcVendor(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
#endif // __VENDING_NPC

#ifdef __AEGON_CONVERT_PERIN
void OnAegonConvertPerin(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
...
void	OnUpdateWeaponRarity(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
...
void	OnCreateOwnTitle(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
void	OnUpdateShowTitle(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
#endif // __SYS_CUSTOM_TITLE

#ifdef __PREMIUM
void	OnUpdateShowPremium(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
#endif //__PREMIUM

#ifdef __MOUNT
void	OnMountChange(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
#endif // __MOUNT

#ifdef __SYS_PARTYFINDER
void	OnPartyList(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
void	OnPartyAllowJoin(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
#endif //__SYS_PARTYFINDER

#ifdef __ANARCHY_SYSTEM
void	OnAnarchyBuffs(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
...
void	OnLootboxRefresh(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
void	OnLootboxStart(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
void	OnLootboxCollect(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
#endif // __AEGON_LOOT_BOX

#ifdef __AEGON_VIEW_INV
void	OnInvView(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
void	OnInvViewCommand(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
...
#ifdef __BADGE
void	OnChangeBadgeIcon(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
#endif //__BADGE

#ifdef __SYS_GUILDCOLOR
void	OnSetGuildColor(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE plBuf, u_long uBufSize);
#endif //__SYS_GUILDCOLOR

#ifdef __SYS_NAMECOLOR
void	OnSetNameColor(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE plBuf, u_long uBufSize);
#endif //__SYS_NAMECOLOR

#ifdef __GUILDFINDER
void	OnGuildList(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
void	OnGuildFinderRequest(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
void 	OnGuildFinderOpt(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
#endif //__GUILDFINDER

#ifdef	__REMOVE_DURATION_ITEMS
void	OnRemoveCmm(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
#endif	//__REMOVE_DURATION_ITEMS

#ifdef __SYS_MONSTER_CLASH
void	OnMonsterClashRegisterWindow(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
void	OnMonsterClashRegister(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
void	OnMonsterClashRegisterMemberWindow(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
void	OnMonsterClashRegisterMember(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
void	OnMonsterClashUnRegisterMember(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
#endif //__SYS_MONSTER_CLASH

#ifdef __REPORT_SYSTEM
void	OnSendReport(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
#endif // __REPORT_SYSTEM

#ifdef __SYS_SANDBOX
void	OnSandbox(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
void	OnSandboxTeleport(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
#endif //__SYS_SANDBOX

#ifdef __CHECKLOAD
void	OnCheckLoad(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
#endif //__CHECKLOAD
...
void	OnLoadAchievementProgress(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
void	OnCheckAchievementProgress(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
void	OnCollectAchievement(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
void	OnAchievementFavorite(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
#endif // __AEGON_ACHIEVEMENT_SYSTEM

#ifdef __AEGON_FULLSCREEN_AND_RESIZE
void	OnReloadTaskbar(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
#endif // __AEGON_FULLSCREEN_AND_RESIZE

#ifdef __PLAYER_LIST
void	OnPlayerListRequest(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
#endif // __PLAYER_LIST

#ifdef __AEGON_CRAFTING_SYSTEM
void	OnCraftRecipe(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
...
void	OnLoadSeasonPassProgress(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
void	OnClaimSeasonPassReward(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
void	OnGetSeasonPassCountdown(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
void	OnPurchaseSeasonPass(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
#endif // __AEGON_SEASON_PASS

#ifdef __AEGON_ADVANCED_ANNOUNCEMENT
void	OnAegonSystemShout(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
#endif // __AEGON_ADVANCED_ANNOUNCEMENT

#ifdef __SWITCH_EQUIP
void	OnEquipSwitch(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
void	OnEquipSwitchUse(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
#endif // __SWITCH_EQUIP


#ifdef __AEGON_PVP_RANKING
void	OnGetPvPRanking(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
#endif // __AEGON_PVP_RANKING

#ifdef __AEGON_PREM_MOTIONS
void	OnPurchaseMotion(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
#endif // __AEGON_PREM_MOTIONS

#ifdef __PET_GLOW
void    GoToChangePetGlow(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
#endif // __PET_GLOW

#ifdef __MODS_MANAGER
void	OnSendModsManager(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
#endif // __MODS_MANAGER

#ifdef __SYS_WORLDBOSS
void	OnRegisterHWID(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
#endif //__SYS_WORLDBOSS

#ifdef __NPC_QUICK_SELL			
void	OnQuickSell(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
#endif // __NPC_QUICK_SELL

#ifdef __AEGON_EMOTE_SYSTEM
void	OnPurchaseEmote(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
#endif //__AEGON_EMOTE_SYSTEM

#ifdef __CRYSTAL
void	OnCrystal(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
#endif // __CRYSTAL

#ifdef __AEGON_INGAME_SHOP
void	OnWebshopPurchase(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
#endif

#ifdef __WORLSERVER_MENU
public:
	static	CDPSrvr* GetInstance(void);
	void	SendExchangeSetApply(DPID dpId);
	void	SendChatSetApply(DPID dpId);
	void	SendPkSetApply(DPID dpId);
	BOOL	m_bExchange;
	BOOL	m_bChat;
	BOOL	m_bPk;
	...
	void	OnCreateTournament(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
	void	OnGetTournamentMap(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
	void	OnDeleteTournament(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
#endif

#ifdef __ROYAL_RUMBLE
	void	OnPlayerSiegeJoin(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
	void	OnGetSiegeRanking(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
#endif // __ROYAL_RUMBLE

#ifdef __AEGON_AUTO_STATS
	void	OnUpdateAutoStats(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
#endif

#ifdef __AEGON_F_TOOL
	void	OnUpdateFTools(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
#endif

#ifdef __REMOVE_SKILL_BUFF
	void	OnSendRemoveSkillBuff(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
#endif // __REMOVE_SKILL_BUFF

#ifdef __AEGON_TIME_DIFF
	void	OnUpdateTimeDiff(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
#endif

#ifdef __FL_BAG_LOOT
	void    OnSelectedBag(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
#endif //__FL_BAG_LOOT

#ifdef __FL_BAG_UPDATE
	void	OnDoUseItemBag(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
#endif //__FL_BAG_UPDATE

#ifdef __AEGON_PVP_MINIGAMES
	void	OnPvPMinigameCreate(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
	void	OnPvPMinigameCommand(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
	void	OnPvPMinigameChat(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
	void	OnPvPMinigameGetList(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
#endif
...
public:
	...
	void	OnMessengerUpdateRequest(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
	void	OnMessengerAddChatUnit(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
#endif

#ifdef __AEGON_BAG_FREE_MOVE
	void OnMovePocketItem(CAr& ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
#endif
