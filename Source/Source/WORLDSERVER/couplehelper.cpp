...
void CCoupleHelper::OnPropose( CUser* pUser, const char* szPlayer )
{
	...
	if( pUser == pTarget )
	{
		pUser->AddText("You can not send yourself a couple request." , COLOR_ERROR);
		return;
	}
