...
#ifdef __VENDING_NPC
private:
	void    OnAddVendorNPC(CAr& ar, DPID dpid, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
	void    OnRemoveVendorNPC(CAr& ar, DPID dpid, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
	void    OnUpdateVendorNPC(CAr& ar, DPID dpid, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
	void    OnGetVendorNPC(CAr& ar, DPID dpid, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);

	void    OnAddVendorNPCLog(CAr& ar, DPID dpid, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
	void    OnRemoveVendorNPCLog(CAr& ar, DPID dpid, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
	void    OnShopCloseLog(CAr& ar, DPID dpid, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);

public:
	void    SendAddVendorNPC(u_long idPlayer, u_long objidVendor, u_long idVendor);
#ifdef __AEGON_IMPROVED_SHOPDESIGN
	void    SendGetVendorNPC(u_long idVendor, u_long idPlayer, D3DXVECTOR3 vPos, FLOAT fAngle, DWORD dwSkillTime, FLOAT fMonsterSize, char* szShopName, char* szPlayerName, DWORD dwItemID, CItemContainer<CItemElem>* pInven, u_long idChannel, u_long idWorld, DWORD dwShopDesign);
#else
	void    SendGetVendorNPC(u_long idVendor, u_long idPlayer, D3DXVECTOR3 vPos, FLOAT fAngle, DWORD dwSkillTime, FLOAT fMonsterSize, char* szShopName, char* szPlayerName, DWORD dwItemID, CItemContainer<CItemElem>* pInven, u_long idChannel, u_long idWorld);
#endif
#endif // __VENDING_NPC

#ifdef __AEGON_INGAME_DP
	void	OnIngameDPCommand(CAr& ar, DPID dpid, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
#endif // __AEGON_INGAME_DP

#ifdef __AEGON_LAST_ONLINE
	void	OnInitLoadLastLogin(CAr& ar, DPID dpid, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
#endif // __AEGON_LAST_ONLINE

#ifdef __BAN_SYSTEM
	void	OnBanUser(CAr& ar, DPID dpid, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
#endif // __BAN_SYSTEM

#ifdef __AEGON_ACHIEVEMENT_SYSTEM
	void	OnSaveAchievementOffline(CAr& ar, DPID dpid, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
#endif // __AEGON_ACHIEVEMENT_SYSTEM

#ifdef __AEGON_PVP_RANKING
	void	OnInitLoadPvPRanking(CAr& ar, DPID dpid, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
	void	OnSavePvPRanking(CAr& ar, DPID dpid, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
#endif // __AEGON_PVP_RANKING

#ifdef __AEGON_INGAME_SHOP
	void	OnInitLoadIngameShop(CAr& ar, DPID dpid, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
#endif //__AEGON_INGAME_SHOP

#ifdef __AEGON_TOURNAMENT
	void OnLoadTournaments(CAr& ar, DPID dpid, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
	void OnSaveTournaments(CAr& ar, DPID dpid, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
#endif //__AEGON_TOURNAMENT

#ifdef __ROYAL_RUMBLE
	void OnSaveWarAllWarPlayers(CAr& ar, DPID dpid, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
	void OnLoadSiegeScore(CAr& ar, DPID dpid, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
	void SendSiegeScore();
