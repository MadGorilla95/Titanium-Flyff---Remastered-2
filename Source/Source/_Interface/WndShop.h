...
class CWndQuickSellCtrl : public CWndBase
{
...
public:
	...
	vector<DWORD> GetItemList();

#ifdef __AEGON_IMPROVED_QUICKSELL
	int SetScrollBarPos(int nPos) { return m_wndScrollBar.SetScrollPos(nPos); };
#endif
...
class CWndQuickSell : public CWndNeuz
{
	CWndQuickSellCtrl	m_wndctrlMerit;
public:
	CWndQuickSell();
	~CWndQuickSell();
...
#ifdef __BUYBACK
	CWndBuyBack* m_pWndBuyBack;
#endif // __BUYBACK
#ifdef __NPC_QUICK_SELL
	CWndQuickSell* m_pWndQuickSell;
#endif // __NPC_QUICK_SELL
