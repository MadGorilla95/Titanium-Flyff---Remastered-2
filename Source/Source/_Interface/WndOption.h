...
class CWndOptTitanium : public CWndNeuz
{
public:
	CWndOptTitanium();
	~CWndOptTitanium();
...
class CWndOptTitanium2 : public CWndNeuz
{
public:
	CWndOptTitanium2();
	~CWndOptTitanium2();
...
#ifdef __TITANIUM_OPTIONS
	CWndOptTitanium		m_OptTitanium;
	CWndOptTitanium2	m_OptTitanium2;
#endif //__TITANIUM_OPTIONS
