...
void CWndGuildTabWar::OnDestroyChildWnd(CWndBase* pWndChild)
{
	if (m_pWndGuildWarDecl == pWndChild)
	{
		SAFE_DELETE(m_pWndGuildWarDecl);
		pWndChild = NULL;
	}
	else if (m_pWndGuildWarGiveUp == pWndChild)
	{
		SAFE_DELETE(m_pWndGuildWarGiveUp);
		pWndChild = NULL;
	}
	else if (m_pWndGuildWarPeace == pWndChild)
	{
		SAFE_DELETE(m_pWndGuildWarPeace);
		pWndChild = NULL;
	}
