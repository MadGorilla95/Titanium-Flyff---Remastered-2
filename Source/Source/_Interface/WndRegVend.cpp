...
*/
#ifdef __VENDING_NPC
CWndRegVend::CWndRegVend(bool bVendor)
#else // __VENDING_NPC
...
#ifdef __CHIP_PLAYERSHOP
	CString str1;
	CWndStatic* pWndMode = (CWndStatic*)GetDlgItem(WIDC_SELLPRI1);

	if (pWndMode)
	{
		switch (m_nMode)
		{
		case 1: str1.Format("Penya"); break;
		case 2: str1.Format("Perin"); break;
		case 3: str1.Format("Red Chip"); break;
		case 4: str1.Format("Red Perin"); break;
		}
		pWndMode->SetTitle(str1);
	}
#endif //__CHIP_PLAYERSHOP
...
void CWndRegVend::OnInitialUpdate()
{
	...
	m_pTex = CAegonThemeSwitcherMng::GetInstance()->ThemeSwitchAddTexture(m_pApp->m_pd3dDevice, "WndVenderArrowEx.tga", COLOR_ITEM_BG, TRUE);
#else // __AEGON_THEME_SWITCHER
	m_pTex = m_textureMng.AddTexture( m_pApp->m_pd3dDevice,  MakePath( DIR_THEME, "WndVenderArrowEx.tga" ), COLOR_ITEM_BG );
#endif

#ifdef __CHIP_PLAYERSHOP
	CWndButton* pWndButton[3];
	pWndButton[0] = (CWndButton*)GetDlgItem(WIDC_BUTTON10);
	pWndButton[1] = (CWndButton*)GetDlgItem(WIDC_BUTTON11);
	pWndButton[1] = (CWndButton*)GetDlgItem(WIDC_BUTTON12);
	pWndButton[1] = (CWndButton*)GetDlgItem(WIDC_BUTTON13);
...
#ifdef __CHIP_PLAYERSHOP
	case WIDC_BUTTON10: m_nMode = 1; break;
	case WIDC_BUTTON11: m_nMode = 2; break;
	case WIDC_BUTTON12: m_nMode = 3; break;
	case WIDC_BUTTON13: m_nMode = 4; break;
#endif // __CHIP_PLAYERSHOP
	case WIDC_VENMAX:
		{
			if(m_pItemBase)
...
#ifdef __CHIP_PLAYERSHOP
		g_DPlay.SendRegisterPVendorItem(m_iIndex, 0, (BYTE)(m_pItemBase->m_dwObjId), nNum, nCost, m_nMode);
