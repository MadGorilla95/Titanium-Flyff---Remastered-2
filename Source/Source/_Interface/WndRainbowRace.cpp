...
{ 
	...
	m_strPathCheck[0] = "CheckRed.tga";
	m_strPathCheck[1] = "CheckOrange.tga";
	m_strPathCheck[2] = "CheckYellow.tga";
	m_strPathCheck[3] = "CheckGreen.tga";
	m_strPathCheck[4] = "CheckBlue.tga";
	m_strPathCheck[5] = "CheckIndigo.tga";
	m_strPathCheck[6] = "CheckViolet.tga";
...
void CWndRainbowRaceMiniGame::OnDraw(C2DRender* p2DRender)
{
	for(int i=0; i<7; i++)
	{
		...
		{
			CTexture* pTexture;
			pTexture = CWndBase::m_textureMng.AddTexture( g_Neuz.m_pd3dDevice, MakePath( DIR_THEME, m_strPathCheck[i]), COLOR_ITEM_BG );
			if(pTexture != NULL)
...
void CWndRRMiniGameKawiBawiBo::OnDraw( C2DRender* p2DRender ) 
{
	...
	{
		pTexture = CWndBase::m_textureMng.AddTexture( g_Neuz.m_pd3dDevice, strMyPath, COLOR_ITEM_BG );
		if(pTexture != NULL)
	...
	{
		pTexture = CWndBase::m_textureMng.AddTexture( g_Neuz.m_pd3dDevice, strComPath, COLOR_ITEM_BG );
		if(pTexture != NULL)
...
{ 
	...
	m_texCardBack = CWndBase::m_textureMng.AddTexture( g_Neuz.m_pd3dDevice, MakePath( DIR_THEME, "RainbowRaceCardBack.tga"), COLOR_ITEM_BG );
...
void CWndRRMiniGameCard::SetQuestion(CString strQuestion)
{
	for(int i=0; i<strQuestion.GetLength(); i++)
	{
		...
		if(m_stCard[i].m_nCardNum >= 0 && m_stCard[i].m_nCardNum < 9)
			m_stCard[i].m_pTexture = CWndBase::m_textureMng.AddTexture( g_Neuz.m_pd3dDevice, MakePath( DIR_THEME, m_strCard[m_stCard[i].m_nCardNum]), COLOR_ITEM_BG );
...
{ 
	...
	m_pTexBg1 = CWndBase::m_textureMng.AddTexture( g_Neuz.m_pd3dDevice, MakePath( DIR_THEME, "WndRainbowRaceLadderBg1.tga"), COLOR_ITEM_BG );
	m_pTexBg2 = CWndBase::m_textureMng.AddTexture( g_Neuz.m_pd3dDevice, MakePath( DIR_THEME, "WndRainbowRaceLadderBg2.tga"), COLOR_ITEM_BG );
	m_pTexHorizon = CWndBase::m_textureMng.AddTexture( g_Neuz.m_pd3dDevice, MakePath( DIR_THEME, "RainbowRaceLadderHorizon.tga"), COLOR_ITEM_BG );
	m_pTexChoice = CWndBase::m_textureMng.AddTexture( g_Neuz.m_pd3dDevice, MakePath( DIR_THEME, "WndRainbowRaceLadderChoice.tga"), COLOR_ITEM_BG );
	m_pTexPoint = CWndBase::m_textureMng.AddTexture( g_Neuz.m_pd3dDevice, MakePath( DIR_THEME, "WndRainbowRaceLadderPoint.tga"), COLOR_ITEM_BG );
	m_pTexGoal = CWndBase::m_textureMng.AddTexture( g_Neuz.m_pd3dDevice, MakePath( DIR_THEME, "WndRainbowRaceLadderGoal.tga"), COLOR_ITEM_BG );
	m_pTexFail = CWndBase::m_textureMng.AddTexture( g_Neuz.m_pd3dDevice, MakePath( DIR_THEME, "WndRainbowRaceLadderFail.tga"), COLOR_ITEM_BG );
