...
#endif
#ifdef __WBQT_GUILD_BUFFS
	m_WndGuildBuffs.Create(WBS_CHILD | WBS_NODRAWFRAME, rect, pWndTabCtrl, APP_GUILD_TAB_BUFFS);
#endif //__WBQT_GUILD_BUFFS
...
#ifdef __WBQT_GUILD_BUFFS
	tabTabItem.pszText = _T("Buffs");
	tabTabItem.pWndBase = &m_WndGuildBuffs;
	pWndTabCtrl->InsertItem(5, &tabTabItem);
#endif //__WBQT_GUILD_BUFFS
