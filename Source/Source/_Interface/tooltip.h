...
#ifdef _WIN64
	void PutToolTip(ULONG_PTR dwToolTipId, CEditString& string, CRect rect, CPoint pt, int nToolTipPos = 0);
	void PutToolTip(ULONG_PTR dwToolTipId, CString& string, CRect rect, CPoint pt, int nToolTipPos = 0);
	void PutToolTip(ULONG_PTR dwToolTipId, LPCTSTR lpszString, CRect rect, CPoint pt, int nToolTipPos = 0);
...
#endif // __NEW_ITEM_VARUNA
#ifdef __MESSENGER_CTRL_EXTENTED
	void SetGuildRankToolTip(DWORD dwToolTipId, int m_nPlayerId);
#endif // __MESSENGER_CTRL_EXTENTED
#ifndef __IMPROVE_MAP_SYSTEM
#if __VER >= 13 // __CSC_VER13_1
