...
#ifndef __FIX_TOOLTIP_INVENTORY
	virtual void OnMouseWndSurface(CPoint point);
#else //__FIX_TOOLTIP_INVENTORY
	void DrawToolTip(CPoint point);
...
public:
	...
	CWndMenu m_wndLockMenu;
	CItemElem* m_pLockItem;
...
#ifdef __AEGON_VIEW_INV
	public:
	CWndMenu m_wndViewInvMenu;
	CItemElem* m_pViewInvItem;
#endif // __AEGON_VIEW_INV
