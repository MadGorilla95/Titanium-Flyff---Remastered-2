...
{ 
	...
	|| strcmp("obj_heavenwall01.o3d", pString) == 0
	|| strcmp("obj_heavenwall02.o3d", pString) == 0
	|| strcmp("obj_heavenwall03.o3d", pString) == 0
	|| strcmp("obj_heavenwall04.o3d", pString) == 0
	|| strcmp("obj_heavenwall05.o3d", pString) == 0
	|| strcmp("obj_heavenwall06.o3d", pString) == 0
	|| strcmp("obj_heavenwall07.o3d", pString) == 0
	|| strcmp("obj_heavenwall08.o3d", pString) == 0
	|| strcmp("obj_heavenwall09.o3d", pString) == 0
	|| strcmp("obj_heavenwall10.o3d", pString) == 0
	|| strcmp("obj_heavenwall11.o3d", pString) == 0
	|| strcmp("obj_heavenwall12.o3d", pString) == 0
	|| strcmp("obj_heavenwall13.o3d", pString) == 0
	|| strcmp("obj_heavenwall14.o3d", pString) == 0
	|| strcmp("obj_heavenwall15.o3d", pString) == 0
	|| strcmp("obj_heavenwall16.o3d", pString) == 0
	|| strcmp("obj_heavenwall17.o3d", pString) == 0
	|| strcmp("obj_heavenwall18.o3d", pString) == 0
	|| strcmp("obj_heavenwall19.o3d", pString) == 0
	|| strcmp("obj_heavenwall20.o3d", pString) == 0
	|| strcmp("obj_heavenwall21.o3d", pString) == 0
	|| strcmp("obj_heavenwall22.o3d", pString) == 0
	|| strcmp("obj_heavenwall23.o3d", pString) == 0
	|| strcmp("obj_heavenwall24.o3d", pString) == 0
	|| strcmp("obj_heavenwall25.o3d", pString) == 0
	|| strcmp("obj_heavenwall26.o3d", pString) == 0
	|| strcmp("obj_heavenwall27.o3d", pString) == 0
	|| strcmp("obj_heavenwall28.o3d", pString) == 0
	|| strcmp("obj_heavenwall29.o3d", pString) == 0
	|| strcmp("obj_heavenwall30.o3d", pString) == 0
	|| strcmp("obj_heavenwall31.o3d", pString) == 0
	|| strcmp("obj_heavenwall32.o3d", pString) == 0
	|| strcmp("obj_heavenwall33.o3d", pString) == 0
	|| strcmp("obj_heavenwall34.o3d", pString) == 0
	|| strcmp("obj_heavenwall35.o3d", pString) == 0
	|| strcmp("obj_heavenwall36.o3d", pString) == 0
	|| strcmp("obj_heavenwall37.o3d", pString) == 0
	|| strcmp("obj_heavenwall38.o3d", pString) == 0
#endif // __GAMEGUARD
	)
	{
		return TRUE;
...
int		CModelObject::LoadBone( LPCTSTR szFileName )
{
	if( m_pBone )
#ifdef _WIN64
		Error("CModelObject::LoadBone ; Bone already Loaded. 0x%08x", reinterpret_cast<INT_PTR>(m_pBone));
#else
...
#ifdef _WIN64
		Error("CModelObject::MovePart : m_Element[%d].m_pObject3D == 0x%16x", nDstPart, (__int64)pDestPart->m_pObject3D);
#else
...
#endif //__BETTER_MODEL_CACHE
{
	...
	if( FAILED( hr = m_pd3dDevice->TestCooperativeLevel() ) )		// 디바이스가 허접하면 에러남김.
	{
		...
		if (IsValidObj(g_pPlayer))
			name = g_pPlayer->GetName();
		LPCTSTR szErr = Error( "%s device failure %08x - char: %s", szFileName, (int)hr, name.GetString() );
		ADDERRORMSG( szErr );

		if (hr == D3DERR_DEVICENOTRESET) 
		{
			szErr = Error("Attempting D3D reset...");
			ADDERRORMSG(szErr);

			g_Neuz.Reset3DEnvironment();
			hr = m_pd3dDevice->TestCooperativeLevel();

			if (FAILED(hr)) 
			{
				szErr = Error("%s reset failure %08x - char: %s", szFileName, (int)hr, name.GetString());
				ADDERRORMSG(szErr);
			}
			else 
			{
				szErr = Error("D3D Reset successful - char: %s", name.GetString());
				ADDERRORMSG(szErr);
			}
		}
	}
...
#ifdef __fmod
			SoundSystemClass::playSound(pAttr->m_nSndID, pvSndPos);
#else
...
void	CModelObject::CreateWeaponEffect( int nParts, DWORD dwItemKind3, const D3DXMATRIX *pmWorld, int nType, int nLevel, int nLevel2 )
{
	...
	switch( dwItemKind3 ) // get the type of the weapon
	{
		...
		case IK3_SHIELD			: dwSfxRegular = XI_WEA_YOYO01;		fOffset = 0.00f; break; // Shield SFX
