...
#ifdef __TRAILS
HRESULT CParticles::InitDeviceObjects(LPDIRECT3DDEVICE9 pd3dDevice, LPCTSTR szFileName, BOOL IsTrail)
#else // __TRAILS
...
#endif // __TRAILS
{
...
#ifdef __CLIENT
	CString strFilePath = MakePath(DIR_MODELTEX, szFileName);
#ifdef __TRAILS
	if (IsTrail)
	{
		strFilePath = MakePath(DIR_SFXTEX, szFileName);
	}

	// Create the texture using D3DX
	hr = LoadTextureFromRes(pd3dDevice, strFilePath.GetString(),
	...
	if (hr == E_FAIL)
	{
		LPCTSTR szErr = Error("%s 읽기 실패", strFilePath.GetString());
		ADDERRORMSG(szErr);
		m_bActive = FALSE;
	}
...
#else // __TRAILS
	{
		...
		if (hr == E_FAIL)
		{
			LPCTSTR szErr = Error("%s 읽기 실패", MakePath(DIR_MODELTEX, szFileName));
			ADDERRORMSG(szErr);
			m_bActive = FALSE;
		}
	}
...
#ifdef __TRAILS
		case 25:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_01.bmp");     break;
		case 26:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_02.bmp");     break;
		case 27:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_03.bmp");     break;
		case 28:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_04.bmp");     break;
		case 29:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_05.bmp");     break;
		case 30:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_06.bmp");     break;
		case 31:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_07.bmp");     break;
		case 32:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_08.bmp");     break;
		case 33:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_09.bmp");     break;
		case 34:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_10.bmp");     break;
		case 35:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_11.bmp");     break;
		case 36:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_12.bmp");     break;
		case 37:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_13.bmp");     break;
		case 38:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_14.bmp");     break;
		case 39:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_15.bmp");     break;
		case 40:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_16.bmp");     break;
		case 41:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_17.bmp");     break;
		case 42:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_18.bmp");     break;
		case 43:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_19.bmp");     break;
		case 44:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_20.bmp");     break;
		case 45:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_21.bmp");     break;
		case 46:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_22.bmp");     break;
		case 47:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_23.bmp");     break;
		case 48:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_24.bmp");     break;
		case 49:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_25.bmp");     break;
		case 50:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_26.bmp");     break;
		case 51:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_27.bmp");     break;
		case 52:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_28.bmp");     break;
		case 53:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_29.bmp");     break;
		case 54:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_30.bmp");     break;
		case 55:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_31.bmp");     break;
		case 56:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_32.bmp");     break;
		case 57:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_33.bmp");     break;
		case 58:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_34.bmp");     break;
		case 59:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_35.bmp");     break;
		case 60:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_36.bmp");     break;
		case 61:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_37.bmp");     break;
		case 62:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_38.bmp");     break;
		case 63:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_39.bmp");     break;
		case 64:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_40.bmp");     break;
		case 65:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_41.bmp");     break;
		case 66:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_42.bmp");     break;
		case 67:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_43.bmp");     break;
		case 68:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_44.bmp");     break;
		case 69:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_45.bmp");     break;
		case 70:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_46.bmp");     break;
		case 71:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_47.bmp");     break;
		case 72:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_48.bmp");     break;
		case 73:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_49.bmp");     break;
		case 74:    pParticles->m_fSize = 0.35f;    strcpy(szFileName, "Itm_sys_scr_trail_50.bmp");     break;
#endif // __TRAILS

		default:									strcpy( szFileName, "etc_Particle2.bmp" );			break;
		
		}

#ifdef __TRAILS
		if (nType > 24)
			pParticles->InitDeviceObjects(m_pd3dDevice, szFileName, TRUE);		// 파티클 텍스쳐 로딩.
		else
#endif // __TRAILS
		{
