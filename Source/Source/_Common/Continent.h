...
public:
	BYTE GetAchievementArea(CMover* pMover);
...
#ifdef __CHECKLOAD
	unsigned char getWorld(const CMover* const player);
	static unsigned char worldIdToMCD(const unsigned long worldId, const bool getWorld = false);
#endif //__CHECKLOAD
