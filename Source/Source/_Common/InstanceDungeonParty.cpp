...
BOOL CInstanceDungeonParty::ForceEnteranceDungeon(CUser* pUser, DWORD dwWorldId, DWORD dwDungeonID,  D3DXVECTOR3 vPos)
{
	return ForceTeleportToDungeon(pUser, dwWorldId, dwDungeonID, vPos);
}
