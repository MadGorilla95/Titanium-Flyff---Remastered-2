...
#ifdef __NEW_NIGHT
static const LIGHTCOLOR gs_kLight2[24] = // diffuse, ambient
{
...
{
	// Night Blending to Day
	0.11f, 0.11f, 0.28f, 0.046f, 0.046f, 0.06f, // 12am Midnight
	0.13f, 0.13f, 0.30f, 0.048f, 0.048f, 0.08f, // 1am
	0.13f, 0.13f, 0.30f, 0.048f, 0.048f, 0.08f, // 2am
	0.15f, 0.15f, 0.32f, 0.05f, 0.05f, 0.10f, // 3am
	0.18f, 0.18f, 0.32f, 0.10f, 0.10f, 0.15f, // 4am
	0.20f, 0.20f, 0.33f, 0.09f, 0.09f, 0.14f, // 5am
	0.25f, 0.23f, 0.33f, 0.25f, 0.23f, 0.25f, // 6am
	// Night over, Starting Sunrise
	0.29f, 0.25f, 0.33f, 0.29f, 0.25f, 0.3f, // 7am
	0.32f, 0.3f, 0.33f, 0.32f, 0.3f, 0.3f, // 8am 
	0.40f, 0.3f, 0.33f, 0.35f, 0.3f, 0.3f, // 9am
	0.5f, 0.4f, 0.4f, 0.5f, 0.4f, 0.4f, // 10am
	// Sunrise Over, Starting Full Beam Day
	0.7f, 0.6f, 0.6f, 0.7f, 0.6f, 0.6f, // 11am
	0.9f, 1.0f, 0.8f, 0.9f, 1.0f, 0.8f, // 12-mid day
	0.7f, 0.6f, 0.6f, 0.7f, 0.6f, 0.6f, // 1pm
	// Full Beam Day Over, Starting Afternoon->sunset
	0.5f, 0.4f, 0.4f, 0.5f, 0.4f, 0.4f, // 2pm
	0.40f, 0.3f, 0.33f, 0.35f, 0.3f, 0.3f, // 3pm
	0.32f, 0.3f, 0.33f, 0.32f, 0.3f, 0.3f, // 4pm
	0.29f, 0.25f, 0.33f, 0.29f, 0.25f, 0.3f, // 5pm
	// Starting night
	0.25f, 0.23f, 0.33f, 0.25f, 0.23f, 0.25f, // 6pm
	0.20f, 0.20f, 0.33f, 0.09f, 0.09f, 0.14f, // 7pm
	0.18f, 0.18f, 0.32f, 0.10f, 0.10f, 0.15f, // 8pm
	0.15f, 0.15f, 0.32f, 0.05f, 0.05f, 0.10f, // 9pm
	0.13f, 0.13f, 0.30f, 0.048f, 0.048f, 0.08f, // 10pm
	0.13f, 0.13f, 0.30f, 0.048f, 0.048f, 0.08f, // 11pm
};

//static const LIGHTCOLOR gs_kLight[24] = // diffuse, ambient
//{
//	0.07f, 0.07f, 0.07f, 0.06f, 0.06f, 0.07f,  // 2
//	0.08, 0.08, 0.08, 0.06f, 0.06f, 0.07f,  // 3
//	0.1f, 0.1f, 0.1f, 0.07f, 0.07f, 0.08f,  // 4
//	0.2f, 0.2f, 0.2f, 0.1f, 0.1f, 0.11f,  // 5
//	0.3f, 0.3f, 0.3f, 0.18f, 0.18f, 0.18f,  // 6
//	0.4f, 0.4f, 0.5f, 0.26f, 0.26f, 0.27f,  // 7
//
...
//	0.6f, 0.6f, 0.6f, 0.4f, 0.4f, 0.5f, // 20
//	0.4f, 0.4f, 0.4f, 0.35f, 0.35f, 0.36f, // 21
//	0.3f, 0.3f, 0.3f, 0.28f, 0.28f, 0.29f, // 22
//	0.2f, 0.2f, 0.2f, 0.2f, 0.2f, 0.21f, // 23
//	0.1f, 0.1f, 0.1f, 0.1f, 0.1f, 0.11f, // 24
//	0.08f, 0.08f, 0.08f, 0.06f, 0.06f, 0.07f  // 1
//};
#else //__NEW_NIGHT
static const LIGHTCOLOR gs_kLight[24] = // diffuse, ambient
{
...
{
#ifdef __NEW_NIGHT
	if (g_Option.m_bNewNight == TRUE)
	{
		memcpy(m_k24Light, gs_kLight, sizeof(LIGHTCOLOR) * 24);
	}
	else
	{
		memcpy(m_k24Light, gs_kLight2, sizeof(LIGHTCOLOR) * 24);
	}
#else //__NEW_NIGHT
	memcpy( m_k24Light, gs_kLight, sizeof( LIGHTCOLOR ) * 24 );
#endif //__NEW_NIGHT
