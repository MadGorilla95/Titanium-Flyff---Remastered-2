...
#ifdef __AEGON_FIXES
		if (kWorldInfo._kSky[0]._bUse && kWorldInfo._kSky[0]._pTexture)
			pSky1 = kWorldInfo._kSky[0]._pTexture;

		if (kWorldInfo._kSky[1]._bUse && kWorldInfo._kSky[1]._pTexture)
			pSky2 = kWorldInfo._kSky[1]._pTexture;

		if (kWorldInfo._kSky[2]._bUse && kWorldInfo._kSky[2]._pTexture)
...
#ifdef __AEGON_FIXES
		if (kWorldInfo._kCloud[0]._bUse && kWorldInfo._kCloud[0]._pTexture)
			pCloud1 = kWorldInfo._kCloud[0]._pTexture;

		if (kWorldInfo._kCloud[1]._bUse && kWorldInfo._kCloud[1]._pTexture)
			pCloud2 = kWorldInfo._kCloud[1]._pTexture;

		if (kWorldInfo._kCloud[2]._bUse && kWorldInfo._kCloud[2]._pTexture)
...
//	if( g_GameTimer.GetSunPercent() )
	...
	if( kWorldInfo._kSun._bUse && kWorldInfo._kSun._pTexture)
		pSun1 = kWorldInfo._kSun._pTexture;

	if( kWorldInfo._kMoon._bUse && kWorldInfo._kMoon._pTexture)
