...
{ 
#ifdef __GAMEGUARD
	if (((CMover*)this)->IsPlayer() && ((CMover*)this)->IsFly() == FALSE) //Inclination fix
		fAngX = 0;
#endif //__GAMEGUARD
...
#ifdef __fmod
			SoundSystemClass::playSound("CtrlCraftCrash.wav", { vPos.x, vPos.y, vPos.z });
#else
	...
	case 2:	// 떨어짐.
		{
			...
			{
#ifdef __fmod
				SoundSystemClass::playSound("CtrlAirmine.wav", { vPos.x, vPos.y, vPos.z });
#else
