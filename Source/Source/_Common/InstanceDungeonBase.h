...
#ifdef __INFO_DUNGEONS
	BOOL		IncreasePlayerCount(CUser* pUser, DWORD dwDungeonId, DWORD dwWorldId);
...
protected:
	...
	BOOL ForceTeleportToDungeon(CUser* pUser, DWORD dwWorldId, DWORD dwDungeonId, D3DXVECTOR3 vPos);
...
#ifdef __TIMER
	void	SerializeDungeonCoolTime(/*CAr& ar,*/ u_long idplayer, vector<CoolDungeons>& v);
#endif //__TIMER

#ifdef __AEGON_SEASON_PASS
	int GetMonsterState(DWORD dwWorldId, DWORD dwDungeonId, DWORD dwMonsterId);
