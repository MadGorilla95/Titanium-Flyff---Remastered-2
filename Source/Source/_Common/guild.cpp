...
CGuild::CGuild()
{
	...
	*m_szNotice				= '\0';
	...
	ZeroMemory(m_adwGuildColor, sizeof(m_adwGuildColor));
...
void CGuild::Serialize( CAr & ar, BOOL bDesc )
{
...
#ifdef __SYS_GUILDCOLOR
		ar.Write(&m_adwGuildColor, sizeof(DWORD) * 3);
#endif //__SYS_GUILDCOLOR
#ifdef __GUILDFINDER
		ar << m_bGuildFinder;
#endif //__GUILDFINDER
	...
	else
	{
		...
		ar >> m_nWin >> m_nLose >> m_nSurrender;
#ifdef __SYS_GUILDCOLOR
		ar.Read(&m_adwGuildColor, sizeof(m_adwGuildColor));
#endif //__SYS_GUILDCOLOR
#ifdef __GUILDFINDER
		ar >> m_bGuildFinder;
#endif //__GUILDFINDER
...
#ifdef __SYS_GUILDCOLOR
BOOL CGuildMng::SetColor(CGuild* pGuild, DWORD R, DWORD G, DWORD B)
{
...
#ifdef __SYS_GUILDCOLOR
	for (int i = 0; i < 3; i++)
		m_adwGuildColor[i] = source.m_adwGuildColor[i];
#endif //__SYS_GUILDCOLOR
	return *this;
}
...
void CGuildMng::AddBuffs(CGuild* pGuild, CUser* pUser /* = nullptr */)
{
	if (pUser)
	{
...
void CGuildMng::RemoveBuffs(CGuild* pGuild, CUser* pUser /* = nullptr */)
{
	if (pUser)
	{
