...
#ifdef __AEGON_FIXES
#define MAX_DISPLAYOBJ			15000
#define MAX_DISPLAYSFX			1500
#else // __AEGON_FIXES
...
#ifdef __DEV_FREECAM
	static CMover*		m_amvrSelectObserve[MAX_MOVEROBSERVE];
#endif //__DEV_FREECAM
	CLandscape**		m_apLand;
...
public:
#ifdef __CHECKLOAD
	unsigned long GetID() const { return m_dwWorldID; }
#else //__CHECKLOAD
...
#ifdef __CHECKLOAD
#define END_LINKMAPBREAK(b)	\
		if (b) break; pObj = pObj->GetNextNode(); } if(b) break; }  if(b) break; } if(b) break; } }
#endif //__CHECKLOAD
