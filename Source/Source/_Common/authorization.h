...
// Merge with DefineTeleporter.h

#define AUTH_OBSERVER      'D' // Do not give anyone !
#define AUTH_GENERAL       'F' // General Auth
#define AUTH_LOGCHATTING   'G' // Do not give anyone !
#define AUTH_JOURNALIST    'H' // Do not give anyone !
#define AUTH_HELPER        'I' // Trial GM
#define AUTH_BALANCE	   'J' // Balance
#define AUTH_GAMEMASTER    'L' // GM
#define AUTH_GAMEMASTER2   'M' // Head GM
#define AUTH_GAMEMASTER3   'N' // Game Designer
#define AUTH_OPERATOR      'O' // Developer
#define AUTH_ADMINISTRATOR 'Z' // Administrator
...
#define AEGON_NINJA_MODE		(DWORD)0x00200000
#endif

#ifdef __GAMEGUARD
#define	FREE_MONEY_MODE			(DWORD)0x00400000
#endif //__GAMEGUARD

#ifdef __AEGON_STAFF_MOB_IGNORE_MODE
#define AEGON_MOB_IGNORE_MODE	(DWORD)0x00800000
#endif
