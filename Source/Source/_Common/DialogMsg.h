...
typedef struct tagCUSTOMTEXT
{
	...
	__AEGON_EMOTE_UNIT* m_pEmoteUnit = NULL;
	int			m_nCurrentAniImage = 0;
...
#ifdef __AEGON_EMOTE_SYSTEM
	void AddAegonEmoticonUser(CObj* pObj, __AEGON_EMOTE_UNIT* pEmoteUnit);
#endif //__AEGON_EMOTE_SYSTEM
...
#ifdef __AEGON_EMOTE_SYSTEM
	void AddTexture(CObj* pObj, CTexture* pTexture, __AEGON_EMOTE_UNIT* emoteUnit = NULL);
