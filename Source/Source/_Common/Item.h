...
#define GetItemProp(arg1) GetItemProp_AdvancedDebug(arg1, __FILE__, __LINE__, __func__)
#endif
...
#if defined(__SQK_MULTIALTERNATEPRICE) && (defined(__WORLDSERVER) || defined(__CLIENT))
	int GetCurrencyCost(DWORD currency);
...
public:
	...
	void	GetMergedPiercingAvail(PPIERCINGAVAIL pa);
#endif //__WEAPON_MERGE

#ifdef __SWITCH_EQUIP
	CPiercing GetPiercing() { return m_piercing; }
...
public:
	...
	void	SetOldRandomOpt(int nOldRandomOpt) { m_iOldRandomOptItemId = (m_iOldRandomOptItemId & 0xFFFFFFFFFFFFFF00) | static_cast<__int64>(nOldRandomOpt & 0x00000000000000FF); }
	__int64* GetOldRandomOptItemIdPtr(void) { return &m_iOldRandomOptItemId; }
#endif // __AEGON_RETURN_AWAKE
...
//#ifdef __AEGON_RETURN_AWAKE
	...
	void	SetOldRandomOpt(int nOldRandomOpt) { m_nOldRandomOptItemId = nOldRandomOpt; }
//#endif // __AEGON_RETURN_AWAKE
...
//	PIERCINGINFO	m_piercingInfo;
	...
	BOOL	IsExpiring( void )
		{	
			if( m_dwKeepTime )
			{
#if defined(__AEGON_FIXES) && defined(__VENDING_NPC)
				ItemProp* tmpProp = GetProp();
				if (tmpProp && tmpProp->dwItemKind3 == IK3_VENDING)
				{
					if (m_dwKeepTime > 0)
						return FALSE;
				}
...
#ifdef __WEAPON_RARITY
extern	BOOL IsValidItem(DWORD dwId);
#endif // __WEAPON_RARITY

#ifdef __CRYSTAL
extern BOOL IsValidCrystal(CItemElem* pItemElem);
#endif // __CRYSTAL
