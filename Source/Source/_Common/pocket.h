...
#ifdef __BETTER_POCKET
#define	MAX_POCKET	3
#define	POCKET_SLOT_SIZE_0		18
#define	POCKET_SLOT_SIZE_1_2	42
#else //__BETTER_POCKET
#define	MAX_POCKET	3
#define	POCKET_SLOT_SIZE_0	6
#define	POCKET_SLOT_SIZE_1_2	24
#endif // __BETTER_POCKET
...
//	BOOL	Add( CItemElem* pItemElem, vector<PocketController_Result>* apResult );
	...
	BOOL	Add(int nPocket, CItemElem* pItemElem, vector<PocketController_Result>* apResult = NULL, BOOL bAddDropLog = FALSE);
#else
