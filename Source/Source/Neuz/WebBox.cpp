...
#ifdef _WIN64
INT_PTR CALLBACK WebDlgProc(HWND hWnd, UINT Msg, WPARAM wParam, LPARAM lParam);
#else
...
void CWebBox::SetPosition(int x, int y)
{

	SetWindowPos(m_hDlg, NULL, x - 1, y, WEB_DEFAULT_X + 5, WEB_DEFAULT_Y, SWP_SHOWWINDOW);
}

#ifdef __AEGON_FULLSCREEN_AND_RESIZE
void CWebBox::SetPositionAndSize(int x, int y, int cx, int cy)
{
	SetWindowPos(m_hDlg, NULL, x - 1, y, cx, cy, SWP_SHOWWINDOW);
}
