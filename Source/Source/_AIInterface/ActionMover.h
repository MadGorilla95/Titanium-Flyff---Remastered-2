...
#ifdef __HEAL_SHOW
extern CHealNumMng g_HealNumMng;
#endif // __HEAL_SHOW
#endif	// __CLIENT
...
public:
#ifdef _WIN64
	int SendActMsg(OBJMSG dwMsg, INT_PTR nParam1 = 0, INT_PTR nParam2 = 0, INT_PTR nParam3 = 0, INT_PTR nParam4 = 0, INT_PTR nParam5 = 0) override;
#else
...
#ifdef _WIN64
	int				ProcessActMsg1(CMover* pMover, OBJMSG dwMsg, INT_PTR nParam1, INT_PTR nParam2, INT_PTR nParam3, INT_PTR nParam4, INT_PTR nParam5);
	int				ProcessActMsg2(CMover* pMover, OBJMSG dwMsg, INT_PTR nParam1, INT_PTR nParam2, INT_PTR nparam3, INT_PTR nParam4, INT_PTR nParam5);
#else
