...
public:
	...
	void	SendGuildSetColor(u_long idGuild, int R, int G, int B);
	void	OnSetGuildColor(CAr& ar, DPID, DPID, DPID, u_long);
...
#ifdef __GAMEGUARD
	void	SendAddPartyMember(u_long uPartyId, u_long idLeader, long nLeaderLevel, long nLeaderJob, BYTE nLeaderSex, u_long idMember, long nMemberLevel, long nMemberJob, BYTE nMemberSex, int* nModeTime);
#else // __GAMEGUARD
...
//	Operator commands
	...
	void	OnGetDiffPlayer(CAr& ar, DPID, DPID, DPID, u_long);
...
public:
	...
	void	SendPartyAssistant(u_long uPartyId, u_long uidAssistant);
...
#ifdef __VENDING_NPC
public:
	void    SendRemoveNPCVendor(u_long idPlayer);
private:
	void    OnRemoveNPCVendor(CAr& ar, DPID, DPID, DPID, u_long);
#endif // __VENDING_NPC

#ifdef __ANARCHY_SYSTEM
public:
	void	OnAnarchyBuff(CAr& ar, DPID, DPID, DPID, u_long);
#endif // __ANARCHY_SYSTEM
#ifdef __GUILDFINDER
public:
	void	OnGuildFinder(CAr& ar, DPID, DPID, DPID, u_long);
#endif //__GUILDFINDER

#ifdef __SYS_MAP_BUFFS
public:
	void	SendCheckMapBuffs();
	void	OnCommandCheckMapBuffs(CAr& ar, DPID, DPID, DPID, u_long);
