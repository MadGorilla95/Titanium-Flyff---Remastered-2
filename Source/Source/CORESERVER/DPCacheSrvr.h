...
//	Operations
	...
	void	SendGuildSetColor(DWORD guildid, int R, int G, int B);
	void	OnGuildSetColor(CAr& ar, DPID dpidCache, DPID dpidUser, u_long uBufSize);
	...
	void	SendGetDiffPlayer(int nCount, CPlayer* pOperator);
...
private:
	...
	void	OnPartyAssistant(CAr& ar, DPID dpidCache, DPID dpidUser, u_long uBufSize);
