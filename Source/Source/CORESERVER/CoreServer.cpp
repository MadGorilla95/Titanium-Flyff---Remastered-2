...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
	...
	hMainWnd = hWnd =
		CreateWindow(szWindowClass, szTitle, WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU | WS_MINIMIZEBOX | WS_VISIBLE
	...
	g_MyTrace.AddLine('\0');
	g_MyTrace.AddLine('\0');
	g_MyTrace.Add(0, FALSE, "CoreServer started.");
	...
	{
		Error("Not DatabaseServer Connect");
		return FALSE;
	}
...
void OnTimer(WORD wTimerID)
{
	if (wTimerID == TIMER_ID_DEFAULT)
	{
		...
		g_dpCoreSrvr.SendCheckMapBuffs();
