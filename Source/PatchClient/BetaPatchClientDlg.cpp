...
//#endif
	...
	m_Total_Progress.SendMessage(PBM_SETBARCOLOR, 0, (LPARAM)RGB(255, 204, 153));
	m_File_Progress.SendMessage(PBM_SETBARCOLOR, 0, (LPARAM)RGB(255, 204, 153));
...
{
	char szBuffer[256];
	sprintf( szBuffer, "%s", SERVER_NAME);
